...
public class BeerLoader implements CommandLineRunner {
	...
	public static UUID BEER_1_UUID;
	public static UUID BEER_2_UUID;
	public static UUID BEER_3_UUID;
	...
	public void loadBeerObjects() {
		...
		Beer b2 = Beer.builder().beerName("Pinball Porter").beerStyle(BeerStyleEnum.PALE_ALE.name()).minOnHand(12)
				.quantityToBrew(200).price(new BigDecimal("12.95")).upc(BEER_2_UPC).build();

		Beer b3 = Beer.builder().beerName("Pinbal Lovers").beerStyle(BeerStyleEnum.PALE_ALE.name()).minOnHand(12)
		...
		BEER_1_UUID = b1.getId();
		System.out.println(b1.getId());
		BEER_2_UUID = b2.getId();
		System.out.println(b2.getId());
		BEER_3_UUID = b3.getId();
